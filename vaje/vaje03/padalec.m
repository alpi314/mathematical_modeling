function [t, h, v] = padalec(start_condtion, end_time, n, parametri, naloga)
    
    d_Y = @(t, Y) differencial(t, Y, parametri, naloga);
    interval = linspace(0,end_time,n);
    [t, res] = ode45(d_Y, interval, start_condtion);
...
function d_Y = differencial(t, Y, parametri, naloga)
    m = parametri(1);
    c = parametri(2);
    S = parametri(3);
    r = parametri(4);
...
function args = aproksimacija()
    ...
    h = [0:2000:10000, 15000, 20000, 25000, 30000, 40000]';
